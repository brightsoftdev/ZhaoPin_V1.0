...
@property (assign, nonatomic) BOOL loginded;
@property (retain, nonatomic) NSString *emailCount;
...
@property (retain, nonatomic) IBOutlet UIButton *salaryButton;
...
@property (retain, nonatomic) IBOutlet UILabel *favoriteLabel;
