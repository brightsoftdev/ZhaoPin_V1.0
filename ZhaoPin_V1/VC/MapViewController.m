...
- (void)viewDidLoad
{
    ...
    [leftButton setBackgroundImage:[[UIImage imageNamed:@"setting-form-back-button"]scaleToSize:CGSizeMake(30, 35)] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
        
    [leftButton setBackgroundImage:[[UIImage imageNamed:@"setting-form-back-button-click"]scaleToSize:CGSizeMake(30, 35)] forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];

    
    self.navigationItem.leftBarButtonItem=leftButton;
    
    
    UIBarButtonItem *rightButton=[[UIBarButtonItem alloc]initWithTitle:@"查看路线" style:UIBarButtonItemStylePlain target:self action:@selector(SearchRoute)];
    [rightButton setBackgroundImage:[[UIImage imageNamed:@"setting-button.png"]scaleToSize:CGSizeMake(25, 35)]
                    forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
    
    [rightButton setBackgroundImage:[[UIImage imageNamed:@"setting-button-click.png"]scaleToSize:CGSizeMake(25, 35)] forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
           ...
           fromLocation:(CLLocation *)oldLocation//
{
    ...
    NSLog(@"获取当前位置信息");
    //通过经纬度得到中文地址
    CLLocation *cc = [[CLLocation alloc]initWithLatitude:22.819938 longitude:108.365707];
